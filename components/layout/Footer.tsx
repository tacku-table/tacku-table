...
const Footer = () => {
    ...
    return (
        <div className="bg-[#EBD8C3] w-full flex flex-col justify-start text-mono100 mx-auto">
            ...
            <ul className="bottom-0 pt-4 pb-10 flex gap-7 text-xs w-4/6 mx-auto justify-between">
